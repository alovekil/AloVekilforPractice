...
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.*
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.inputCode2
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.view.*
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.view.btn_enterCode
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.view.btn_enterNumber
import kotlinx.android.synthetic.main.fragment_phone_number_lawyer.view.inputCode1
...
class PhoneNumberLawyerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_phone_number_lawyer, container, false)
        ...
        view.btn_enterCode.setOnClickListener {
            if(!inputCode1.text.toString().trim().isEmpty() && !inputCode2.text.toString().trim().isEmpty() && !inputCode3.text.toString().trim().isEmpty() &&
                !inputCode4.text.toString().trim().isEmpty() &&!inputCode5.text.toString().trim().isEmpty() && !inputCode6.text.toString().trim().isEmpty()){
